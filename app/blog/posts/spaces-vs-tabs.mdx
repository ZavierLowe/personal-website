---
title: 'My Journey into Web Devlopment'
publishedAt: '2024-07-17'
summary: 'Explore the enduring debate between using spaces and tabs for code indentation, and why this choice matters more than you might think.'
---

My journey into web development has been a fun but difficult one where there were many ups and downs with going towards the goal of getting a joob as a devloper.
